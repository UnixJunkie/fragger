...
(* OASIS_START *)
(* DO NOT EDIT (digest: c600059657f7767412ea5895c59dae40) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "bb_atom_quads.ml"});
               Executable
                 ({
                     cs_name = "get_frag";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "get_frag.ml"});
               Executable
                 ({
                     cs_name = "query";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "query.ml"})
            ];
     ...
     oasis_digest =
       Some "\007\005\030\227\227\188|\019\227\225\174|m\210\255q";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
